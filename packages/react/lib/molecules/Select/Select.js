...
const Select = ({ options = [], label = "Please select an options...", onOptionSelected: handler, renderOption, }) => {
    ...
    return (React.createElement("div", { className: "dse-select" },
        React.createElement("button", { "aria-haspopup": true, "aria-expanded": isOpen ? true : undefined, "aria-controls": "dse-select-list", ref: labelRef, onKeyDown: onButtonKeyDown, className: "dse-select__label", onClick: onLabelClick },
        ...
        isOpen && (React.createElement("ul", { role: "menu", style: { top: overlayTop }, className: "dse-select__overlay" }, options.map((option, optionIndex) => {
